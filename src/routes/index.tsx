...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://medi-care-clinic.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://medi-care-clinic.lovable.app/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "MediCare Clinic offers compassionate, expert healthcare with easy online appointment booking.",
          telephone: "+1-555-123-4567",
          email: "hello@medicareclinic.com",
          address: {
            "@type": "PostalAddress",
            streetAddress: "128 Wellness Avenue",
          ...
          medicalSpecialty: ["PrimaryCare", "Cardiovascular", "Pediatric", "Dentistry"],
          potentialAction: {
            "@type": "ReserveAction",
            target: "https://medi-care-clinic.lovable.app/book",
